...
def naked_twins(values):
    ...
    naked_twins = [[twin1, twin2] for twin1 in two_digit_boxes for twin2 in peers[twin1] if values[twin1] == values[twin2]]
    ...
    for i in range(len(naked_twins)):
        ...
        peers_both = peers_twin1.intersection(peers_twin2)
        for peer in peers_both:
            if peer != twin1 and peer!= twin2:
                for digit in values[twin1]:
                    digit = assign_value(values, peer, values[peer].replace(digit, ''))
    return values
